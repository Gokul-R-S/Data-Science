...
def add_or_update_expense(expense_date: date, expenses: List[Expense]):
    ...
    for exp in expenses:
        try:
            ...
            logger.error(f"Failed to insert expense (date: {expense_date}, amount: {exp.amount}, category: {exp.category}): {e}")
            errors.append(f"Failed to insert expense (amount: {exp.amount}, category: {exp.category}): {e}") # errors list
